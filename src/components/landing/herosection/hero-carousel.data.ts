...
export const carouselItems: HeroCarouselItem[] = [
...

  {
    ...
    faDescription:
      "WIDIN با بیش از ۳۰ سال تجربه، مجموعه‌ای از فرزهای انگشتی تمام‌کارباید، مته‌ها و قلاویزهای باکیفیت را برای کاربرد در صنایع مختلف ارائه می‌کند.",
  },

  {
    ...
    faDescription:
      "IZAR CUTTING TOOLS یکی از تولیدکنندگان مطرح اروپایی در زمینه ابزارهای برشی HSS و کارباید است و طیف گسترده‌ای از مته‌های مارپیچ، فرزهای انگشتی و سایر ابزارهای برشی را تولید می‌کند.",
  },

  {
    ...
    faTitle: "ابزارهای تخصصی صنعت خودرو",

          ...
          <div className="flex items-end ps-[7vw] pt-12 pb-14">
            <div className="max-w-[900px]">
              <div className="technical-title overflow-hidden">
                <h2 className="technical-title-line text-foreground text-[80px] font-semibold ltr:leading-[0.98] ltr:tracking-[-0.045em] rtl:text-[64px] rtl:leading-[1.2]">
                  {t("titleLine1")}
                </h2>
              </div>

              <div className="technical-title mt-1 overflow-hidden">
                <h2 className="technical-title-line text-custom-primary text-[64px] font-semibold ltr:leading-[0.98] ltr:tracking-[-0.045em] rtl:text-[56px] rtl:leading-[1.2]">
                  {t("titleLine2")}
                </h2>
              </div>

              <p className="technical-description text-muted-foreground mt-7.5 max-w-[660px] text-[15px] leading-8">
                {t("description")}
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-[0.42fr_1.58fr]">
          ...
          <div className="relative py-10 pe-12">
            ...
            <div className="technical-list-label">
              <p className="text-muted-foreground mt-4 max-w-[288px] text-justify text-[15px] leading-7">
                <span className="text-custom-primary text-[24px] font-medium">{t("listDescription1")}</span>
                {t("listDescription2")}
              </p>
            </div>
          </div>

      ...
      <div className="border-border-secondary bg-background flex max-h-[calc(100vh-80px)] flex-col overflow-hidden border">
        ...
        >
          ...
          <Link
            ...
            className={cn(
              "border-border-secondary group relative flex min-h-[64px] shrink-0 items-center gap-3 border-b py-2.5 ps-4 pe-5",
            ...
            {brands.map((brand) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "border-border-secondary group relative flex min-h-[64px] items-center gap-3 border-b py-2.5 ps-3 pe-5 last:border-b-0",
                    "transition-colors duration-200",
                    "hover:bg-custom-primary/[0.04]",
